//=========================================================
//
// シンプルメッシュシリンダー処理 [ simplemeshcylinder.h ]
// Author: Asuma Nishio
//
//=========================================================
...
// メッシュシリンダークラスを定義
//*********************************************************
class CSimpleMeshCylinder : public CObject
{
public:
	...
	CSimpleMeshCylinder(int nPriority = static_cast<int>(CObject::PRIORITY::BILLBOARD));
	~CSimpleMeshCylinder();
	...
	static CSimpleMeshCylinder* Create(D3DXVECTOR3 pos, float fRadius);
